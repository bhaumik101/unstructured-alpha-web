...
_PAGE_BENEFIT = {
    ...
    "Catalyst Command Center":    "Rank verified macro and company events by affected portfolio weight, save private plans, and receive near-event or review prompts in your morning brief.",
