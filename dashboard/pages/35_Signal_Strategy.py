...
_strategy_section = render_sidebar_base(
    ...
    section_key="signal_strategy_section_rail",
)

render_page_header(
    "Signal-Driven Strategy",
    "Test a point-in-time macro strategy against SPY with configurable exposure rules and transaction costs.",
)
...
if _strategy_section == "Performance Summary":
    # ── Live signal state ─────────────────────────────────────────────────────────
